...
Shader "Custom/My Transparent Shader"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float3 WorldPosition2_g914 = ase_worldPos;
			float temp_output_7_0_g917 = AHF_FogDistanceStart;
			half FogDistanceMask12_g914 = pow( abs( saturate( ( ( distance( WorldPosition2_g914 , _WorldSpaceCameraPos ) - temp_output_7_0_g917 ) / ( AHF_FogDistanceEnd - temp_output_7_0_g917 ) ) ) ) , AHF_FogDistanceFalloff );
			float3 lerpResult258_g914 = lerp( (AHF_FogColorStart).rgb , (AHF_FogColorEnd).rgb , ( saturate( ( FogDistanceMask12_g914 - 0.5 ) ) * AHF_FogColorDuo ));
			...
			float DirectionalMask30_g914 = pow( abs( ( (dotResult145_g914*0.5 + 0.5) * AHF_DirectionalIntensity ) ) , AHF_DirectionalFalloff );
			...
			#endif
			float3 temp_output_2_0_g916 = staticSwitch442_g914;
			float3 gammaToLinear3_g916 = GammaToLinearSpace( temp_output_2_0_g916 );
			#ifdef UNITY_COLORSPACE_GAMMA
				float3 staticSwitch1_g916 = temp_output_2_0_g916;
			#else
				float3 staticSwitch1_g916 = gammaToLinear3_g916;
			#endif
			float3 temp_output_256_0_g914 = staticSwitch1_g916;
			float3 temp_output_95_86_g904 = temp_output_256_0_g914;
			half3 AHF_FogAxisOption181_g914 = AHF_FogAxisOption;
			float3 break159_g914 = ( WorldPosition2_g914 * AHF_FogAxisOption181_g914 );
			float temp_output_7_0_g919 = AHF_FogHeightEnd;
			half FogHeightMask16_g914 = pow( abs( saturate( ( ( ( break159_g914.x + break159_g914.y + break159_g914.z ) - temp_output_7_0_g919 ) / ( AHF_FogHeightStart - temp_output_7_0_g919 ) ) ) ) , AHF_FogHeightFalloff );
			...
			float mulTime204_g914 = _Time.y * 2.0;
			float3 temp_output_197_0_g914 = ( ( WorldPosition2_g914 * ( 1.0 / AHF_NoiseScale ) ) + ( -AHF_NoiseSpeed * mulTime204_g914 ) );
			float3 p1_g920 = temp_output_197_0_g914;
			float localSimpleNoise3D1_g920 = SimpleNoise3D( p1_g920 );
			float temp_output_7_0_g918 = AHF_NoiseDistanceEnd;
			half NoiseDistanceMask7_g914 = saturate( ( ( distance( WorldPosition2_g914 , _WorldSpaceCameraPos ) - temp_output_7_0_g918 ) / ( 0.0 - temp_output_7_0_g918 ) ) );
			float lerpResult198_g914 = lerp( 1.0 , (localSimpleNoise3D1_g920*0.5 + 0.5) , ( NoiseDistanceMask7_g914 * AHF_NoiseIntensity ));
			...
			#endif
			float temp_output_43_0_g914 = ( staticSwitch42_g914 * AHF_FogIntensity );
			float temp_output_95_87_g904 = temp_output_43_0_g914;
			float3 lerpResult82_g904 = lerp( float3( 0,0,0 ) , temp_output_95_86_g904 , temp_output_95_87_g904);
			o.Emission = lerpResult82_g904;
			o.Smoothness = 0.8;
...
/*ASEBEGIN
Version=18800
1920;13;1906;1009;330.2205;-461.2078;1.74054;True;False
...
Node;AmplifyShaderEditor.FunctionNode;85;1408,1056;Inherit;False;Apply Height Fog;0;;904;950890317d4f36a48a68d150cdab0168;0;1;81;FLOAT3;0,0,0;False;3;FLOAT3;85;FLOAT3;86;FLOAT;87
...
WireConnection;0;2;85;85
WireConnection;0;4;55;0
WireConnection;0;9;81;0
WireConnection;0;11;48;0
ASEEND*/
//CHKSM=1AA6990C09C129B013AF63EC0D76BBBA4819DEA6